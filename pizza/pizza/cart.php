...
<head>
<title>LA Gourmet Check out </title>

</head>

<body bgcolor="#F19503" topmargin="0" leftmargin="0">
<SCRIPT LANGUAGE="php">
session_cache_limiter('none');
session_start();
</SCRIPT><html dir="ltr">
...
// include "includes/menu.htm";
         ...
         <table  border="0" align="center" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="85%" id="AutoNumber1">
  <tr>
