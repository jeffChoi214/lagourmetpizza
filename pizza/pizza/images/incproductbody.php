...
print "<script language=\"javascript\" type=\"text/javascript\">var totAdd2 = 0; var totAdd1; totAdd1 = 'unset'; var totAdd1x; totAdd1x = 'unset';</script>";
...
<script language=\"javascript\" type=\"text/javascript\">
<!--
var totAddoriginal=" . $rs["pPrice"] . ";
function checkupdateprice999$modnum$Count(){
var totAdd3;
if(document.forms.tForm$Count.optn999$modnum.checked == true)
totAdd2=totAdd2+pricechecker(document.forms.tForm$Count.optn999$modnum.value);
else
totAdd2=totAdd2-pricechecker(document.forms.tForm$Count.optn999$modnum.value);
totAdd1x = totAdd2;
testnum = '$Count';
...
$aOption[1][$index] .= "<td valign=top>";

						$aOption[1][$index] .= '<input type="checkbox" onclick="checkupdateprice999' . $modnum . $Count . '()" name="optn999' . $modnum . '" id="optn999' . $modnum . '" size="1" ';
