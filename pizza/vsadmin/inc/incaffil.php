		    ...
		    <form method="post" action="adminaffil.php" onsubmit="return checkform(this)">
			  <table width="100%" border="0" cellspacing="0" cellpadding="3" bgcolor="">
				...
				<tr>
				  ...
				  <td width="25%" align="left"><?php print trim(@$_GET["id"])?>
					<input type="hidden" name="affilid" size="20" value="<?php print trim(@$_GET["id"])?>" />
				  ...
				  <td width="25%" align="left"><input type="text" name="affilpw" size="20" value="<?php print $affilPW?>" /></td>
				</tr>
				<tr>
				  <td width="25%" align="right"><strong><font color='#FF0000'>*</font><?php print $yyName?>:</strong></td>
				  <td width="25%" align="left"><input type="text" name="name" size="20" value="<?php print $affilName?>" /></td>
				  <td width="25%" align="right"><strong><font color='#FF0000'>*</font><?php print $yyEmail?>:</strong></td>
				  <td width="25%" align="left"><input type="text" name="email" size="25" value="<?php print $affilEmail?>" /></td>
				</tr>
				<tr>
				  <td width="25%" align="right"><strong><font color='#FF0000'>*</font><?php print $yyAddress?>:</strong></td>
				  <td width="25%" align="left"><input type="text" name="address" size="20" value="<?php print $affilAddress?>" /></td>
				  <td width="25%" align="right"><strong><font color='#FF0000'>*</font><?php print $yyCity?>:</strong></td>
				  <td width="25%" align="left"><input type="text" name="city" size="20" value="<?php print $affilCity?>" /></td>
				</tr>
				<tr>
				  <td width="25%" align="right"><strong><font color='#FF0000'>*</font><?php print $yyState?>:</strong></td>
				  <td width="25%" align="left"><input type="text" name="state" size="20" value="<?php print $affilState?>" /></td>
...
?>
				...
				<tr>
				  ...
				  <td width="25%" align="left"><input type="text" name="zip" size="10" value="<?php print $affilZip?>" /></td>
				...
				<tr>
				  ...
				  <td colspan="3"><input type="text" name="affilCommision" size="6" value="<?php print $affilCommision?>" />%</td>
				</tr>
				<tr>
...
<?php
		...
		while($rs=mysql_fetch_array($alldata)){ ?>
				<tr>
				  <td><a href="adminaffil.php?id=<?php print $rs[0]?>"><strong><?php print $rs[0]?></strong></a></td>
				  <td><?php print $rs[1]?></td>
				  <td><a href="mailto:<?php print $rs[3]?>"><?php print $rs[3]?></a></td>
				  <td align=right><?php
			...
			if(! is_numeric($rs2[0])){
				...
				$thistotal=(double)$rs2[0];
				  ...
				  <td align="center"><input type=button name=delete value="Delete" onclick="delrec('<?php print str_replace("'","\'",$rs[0])?>')" /></td>
				</tr>
<?php
		} ?>
				<tr> 
