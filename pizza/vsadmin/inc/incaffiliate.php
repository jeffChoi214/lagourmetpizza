          ...
          <td width="100%">
		    <form method="post" action="affiliate.php">
			  <table width="<?php print $innertablewidth?>" border="0" cellspacing="<?php print $innertablespacing?>" cellpadding="<?php print $innertablepadding?>" bgcolor="<?php print $innertablebg?>">
				<tr>
				  <td width="100%" align="center" colspan="2"><strong>Affiliate Partners Program. Welcome <?php print $xxAffPrg . " " . $xxWelcom . " " . $_SESSION["xaffilName"]?>.</strong></td>
				</tr>
				<tr>
...
<?php
	...
	if(! $addsuccess){
		...
		$sSQL = "SELECT affilName,affilPW,affilAddress,affilCity,affilState,affilZip,affilCountry,affilEmail,affilInform FROM affiliates WHERE affilID='" . trim(@$_SESSION["xaffilid"]) . "' AND affilPW='" . trim(@$_SESSION["xaffilpw"]) . "'";
		$result = mysql_query($sSQL) or print(mysql_error());
				...
				<tr>
				  ...
				  <td width="25%" align="left"><?php
					if(@$_POST["editaffil"] != "" && trim(@$_SESSION["xaffilid"]) != ""){
						print trim(@$_SESSION["xaffilid"]);
						?><input type="hidden" name="affilid" size="<?php print atb(20)?>" value="<?php print trim(@$_SESSION["xaffilid"])?>" />
						  <input type="hidden" name="editaction" value="modify" /><?php
					}else{
						?><input type="text" name="affilid" size="<?php print atb(20)?>" value="<?php print $sAffilid?>" />
				  ...
				  <td width="25%" align="left"><input type="password" name="affilpw" size="<?php print atb(20)?>" value="<?php print $sAffilPW?>" /></td>
				</tr>
				<tr>
				  <td width="25%" align="right"><strong><font color='#FF0000'>*</font><?php print $xxName?>:</strong></td>
				  <td width="25%" align="left"><input type="text" name="name" size="<?php print atb(20)?>" value="<?php print $sAffilName?>" /></td>
				  <td width="25%" align="right"><strong><font color='#FF0000'>*</font><?php print $xxEmail?>:</strong></td>
				  <td width="25%" align="left"><input type="text" name="email" size="<?php print atb(25)?>" value="<?php print $sAffilEmail?>" /></td>
				</tr>
				<tr>
				  <td width="25%" align="right"><strong><font color='#FF0000'>*</font><?php print $xxAddress?>:</strong></td>
				  <td width="25%" align="left"><input type="text" name="address" size="<?php print atb(20)?>" value="<?php print $sAffilAddress?>" /></td>
				  <td width="25%" align="right"><strong><font color='#FF0000'>*</font><?php print $xxCity?>:</strong></td>
				  <td width="25%" align="left"><input type="text" name="city" size="<?php print atb(20)?>" value="<?php print $sAffilCity?>" /></td>
				</tr>
				<tr>
				  <td width="25%" align="right"><strong><font color='#FF0000'>*</font><?php print $xxAllSta?>:</strong></td>
				  <td width="25%" align="left"><input type="text" name="state" size="<?php print atb(20)?>" value="<?php print $sAffilState?>" /></td>
...
?>
				...
				<tr>
				  ...
				  <td width="25%" align="left"><input type="text" name="zip" size="<?php print atb(10)?>" value="<?php print $sAffilZip?>" /></td>
...
<?php } ?>
				<tr>
				  ...
				  <td><input type="text" name="affilid" size="<?php print atb(20)?>" value="<?php print unstripslashes(trim(@$_POST["affilid"]))?>" /></td>
				</tr>
				<tr>
				  <td width="50%" align="right"><?php print $xxPwd?>:</td>
				  <td><input type="password" name="affilpw" size="<?php print atb(20)?>" value="<?php print unstripslashes(trim(@$_POST["affilpw"]))?>" /></td>
				</tr>
				<tr>
        ...
        <tr> 
          <td width="100%">
		    <form method="post" action="affiliate.php">
			  <table width="<?php print $innertablewidth?>" border="0" cellspacing="<?php print $innertablespacing?>" cellpadding="<?php print $innertablepadding?>" bgcolor="<?php print $innertablebg?>">
				<tr>
				  <td width="100%" align="center" colspan="2"><strong><?php print $xxAffPrg . " " . $xxWelcom . " " . @$_SESSION["xaffilName"]?>.</strong></td>
				</tr>
				<tr>
				  <td width="100%" align="center" colspan="2">&nbsp;</td>
				</tr>
				...
				<tr>
				  <td width="100%" colspan="2"><font size="1">
				    <ul>
					  <li><?php print $xxAffLI1?> <strong>products.php?PARTNER=<?php print trim(@$_SESSION["xaffilid"])?></strong></li>
