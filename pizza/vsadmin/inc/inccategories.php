...
if($theid=="0")
	$tslist .= ' &raquo; <a href="products.php">' . $xxAlProd . "</a>";
else
	$tslist .= ' &raquo; <a href="products.php?cat=' . $theid . '">' . $xxAlProd . "</a>";
...
<?php		}
		...
		while($rs=mysql_fetch_row($result)){
			...
			if($alldiscounts!= "") print ' <font color="#FF0000"><strong>' . $xxDsApp . '</strong><br /><font size="1">' . $alldiscounts . '</font></font>';
