...
$success=TRUE;
$sSQL = "SELECT adminEmail,adminStoreURL,adminProdsPerPage,adminShipping,adminUSPSUser,adminUSPSPw,adminZipCode,adminEmailConfirm,adminCountry,adminUnits,adminDelUncompleted,adminPacking,adminStockManage,adminHandling,adminTweaks,adminDelCC,currRate1,currSymbol1,currRate2,currSymbol2,currRate3,currSymbol3,currConvUser,currConvPw,adminCanPostUser,adminlanguages,adminlangsettings FROM admin WHERE adminID=1";
...
if(@$_POST["posted"]=="1"){
	...
	$sSQL = "UPDATE admin SET adminEmail='" . @$_POST["email"] . "',adminStoreURL='" . @$_POST["url"] . "',adminProdsPerPage='" . @$_POST["prodperpage"] . "',adminShipping=" . @$_POST["shipping"] . ",adminUSPSUser='" . @$_POST["USPSUser"] . "',adminUSPSPw='" . @$_POST["USPSPass"] . "',adminZipCode='" . @$_POST["zipcode"] . "',adminCountry=" . @$_POST["countrySetting"] . ",adminDelUncompleted=" . @$_POST["deleteUncompleted"] . ",adminDelCC=" . @$_POST["adminDelCC"] . ",adminPacking=" . @$_POST["packing"] . ",adminStockManage=" . @$_POST["stockManage"] . ",adminHandling=" . @$_POST["handling"] . ",adminTweaks=" . $admintweaks . ",adminCanPostUser='" . @$_POST["adminCanPostUser"] . "',";
	...
	$allcurrencies="";
	$numcurrencies=0;
	$sSQL = "SELECT DISTINCT countryCurrency FROM countries WHERE countryLCID<>'' ORDER BY countryCurrency";
	$result = mysql_query($sSQL) or print(mysql_error());
...
<?php }else{ ?>
	...
	<?php	} ?>
			<tr>
			  ...
			  <tr>
				<td width="50%" align="center"><strong><?php print $yyUname?>: </strong><input type="text" size="15" name="USPSUser" value="<?php print $rsAdmin["adminUSPSUser"]?>" /></td>
				<td width="50%" align="center"><strong><?php print $yyPass?>: </strong><input type="text" size="15" name="USPSPass" value="<?php print $rsAdmin["adminUSPSPw"]?>" /></td>
			  </tr>
			  <tr>
			  ...
			  <tr>
				<td width="100%" align="center" colspan="2"><hr width="70%"><?php print $yyUPSUnt?><br />
				  <font size="1"><?php print $yyUntNote?></font></td>
			  </tr>
			  <tr>
				<td width="50%" align="right"><strong><?php print $yyShpUnt?>: </strong></td>
				<td width="50%" align="left"><select name="adminUnits" size="1">
					<option value="1" <?php if((int)($rsAdmin["adminUnits"])==1) print "selected"?>><?php print $yyUntLbs?></option>
					<option value="0" <?php if((int)($rsAdmin["adminUnits"])==0) print "selected"?>><?php print $yyUntKgs?></option>
					</select></td>
			  </tr>
			  <tr>
			  ...
			  <tr>
				<td width="100%" align="center" colspan="2"><hr width="70%" />How many languages will this store support?</td>
			  </tr>
			  <tr>
				<td width="50%" align="right"><strong>Number of languages: </strong></td>
