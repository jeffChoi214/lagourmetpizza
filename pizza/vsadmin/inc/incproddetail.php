...
print "<script language=\"javascript\" type=\"text/javascript\">var totAdd2$Count = 0; var totAddoriginal$Count=" . $rs["pPrice"] . "; var totAdd1$Count; totAdd1$Count = 'unset'; var totAdd1x$Count; totAdd1x$Count = 'unset';</script>";
...
<script language=\"javascript\" type=\"text/javascript\">
<!--
function check" . $rowcounter . "updateprice999$modnum(){
var totAdd3$Count;
if(document.forms.tForm0.optn" . $rowcounter . "999$modnum.checked == true)
totAdd2$Count=totAdd2$Count+pricechecker(document.forms.tForm0.optn" . $rowcounter . "999$modnum.value);
else
totAdd2$Count=totAdd2$Count-pricechecker(document.forms.tForm0.optn" . $rowcounter . "999$modnum.value);
...
$aOption[1][$index] .= "<td>";
						...
						$aOption[1][$index] .= '<input type="checkbox" onclick="check' . $rowcounter . 'updateprice999' . $modnum . '()" name="optn' . $rowcounter . '999' . $modnum . '" id="optn' . $rowcounter . '999' . $modnum . '" size="1" ';
