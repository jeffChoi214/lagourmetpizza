...
function writepagebar($CurPage, $iNumPages){
	global $catid,$tid,$xxNext,$xxPrev;
	$sLink = "<a href='products.php";
	if($catid<>"0") $sLink .= "?cat=" . $catid . "&pg="; else $sLink .= "?pg=";
...
if(! $isrootsection) $tslist .= " &raquo; " . $xxAlProd;
if($catid=="0"){
	$disabledsections = "";
	$addcomma="";
